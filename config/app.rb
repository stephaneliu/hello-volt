...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-dashboard.com'
  config.app_name = 'Volt_dashboard'
  config.mailer.from = 'Volt_dashboard <no-reply@volt-dashboard.com>'
  ...
  #
  config.app_secret = '9FzjXtqLRpDtg9c26XzDpfl1i3xVGt7ElF3myb6r___x2hDsZDloa2QLGJPPGteP8jU'
